...
function PrngMarbleBag(_motherMarbles, _prngGenerator = __PrngSystem()) constructor{
    ...
    static PullMarble = function(_withReplacement = false, _replenish = true, _prngGenerator = prngGenerator)
    {
    ...
    static AddMarble = function(_marble, _instantlyAvailable = true, _prngGenerator = prngGenerator)
    {
    ...
    static GetMarbleCount = function()
    {
